...
// Driver Licence withdraw
_Btn8 ctrlSetText localize "STR_pInAct_driverfalse";
_Btn8 buttonSetAction "[life_pInact_curTarget] spawn life_fnc_licence_remove; closeDialog 0;";
