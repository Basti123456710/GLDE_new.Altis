...
switch (_shop) do
{
	...
	case "gas": {["Gas Station Market",["water","redgull","tbacon","lockpick","pickaxe","fuelF"]]};
	...
	case "cop": {["Cop Item Shop",["donuts","coffee","spikeStrip","cone","barrier","water","rabbit","apple","redgull","fuelF","defusekit"]]};
